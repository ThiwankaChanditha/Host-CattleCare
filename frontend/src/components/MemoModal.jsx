...
export default function MemoModal({ isOpen, onClose, memo = null, onMemoUpdate }) {
  const { token } = useAuth();
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <h4 className={`font-semibold text-sm ${
                              memo.status === 'completed' ? 'line-through text-gray-500' : 'text-gray-900'
                            }`}>
                              {memo.title}
                            </h4>
                          ...
                          <p className={`text-sm mb-2 ${
                            memo.status === 'completed' ? 'text-gray-400' : 'text-gray-600'
                          }`}>
                            {memo.content}
                          </p>
                          {memo.due_date && (
